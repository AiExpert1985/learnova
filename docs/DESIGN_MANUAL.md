...
For detailed coding standards, see: `docs/DEVELOPMENT_GUIDELINES.md`
...
2. **Feature-based organization** - Keep feature code together
3. **No over-engineering** - Solve current problems, not hypothetical ones
4. **Extract when files > 150 lines** - Not before
5. **Test business logic only** - No widget tests
6. **Use existing getters** - Don't recreate logic
7. **Result pattern for errors** - Never throw in services
8. **Provider-agnostic** - Keep LLM abstraction generic

**When uncertain:**
- Check DEVELOPMENT_GUIDELINES.md for coding standards
- Check this manual for architectural patterns
- Ask before introducing new libraries or patterns
- Prefer simplicity over cleverness

---

*Last Updated: After Step 1 completion and QA screen refactoring*
